...
using SampleDDDWebApiApp.DataAccess.Seeder;
using SampleDDDWebApiApp.Models.AutoMapper;

namespace SampleDDDWebApiApp.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AppDbContext>(options => {
                options.UseSqlServer(connectionString, b => b.MigrationsAssembly("SampleDDDWebApiApp.DataAccess")).UseLazyLoadingProxies();
            });
        ...
        private void InitDbD(IApplicationBuilder app)
        {
